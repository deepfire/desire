...
(defgeneric run-module-test (type module-name &optional verbose-internals)
  (:method :around (type module-name &optional verbose-internals)
    (declare (ignore verbose-internals))
    (with-recorded-status (:record-backtrace t)
      (unwind-protect (call-next-method)
        (finish-output *standard-output*)
        (finish-output *error-output*))))
  (:method ((o (eql :master-reachability-phase)) mn &optional verbose-internals)
    (declare (ignore verbose-internals))
    (touch-module mn))
  (:method ((o (eql :master-update-phase)) mn &optional verbose-internals)
    (declare (ignore verbose-internals))
    (let ((*fetch-errors-serious* t))
      (update mn)
      t))
  (:method ((o (eql :slave-fetch-phase)) mn &optional verbose-internals)
    (declare (ignore verbose-internals))
    (let ((*fetch-errors-serious* t)
          (*break-on-signals* 'error))
      (update mn)
      t))
  (:method ((o (eql :slave-recurse-phase)) mn &optional verbose-internals)
    (desire (list mn) :skip-present t :seal nil :verbose verbose-internals)
    t)
  (:method ((o (eql :slave-load-phase)) mn &optional verbose-internals)
    (declare (ignore verbose-internals))
    (asdf:oos 'asdf:load-op mn)
    t)
  (:method ((o (eql :slave-test-phase)) mn &optional verbose-internals)
    (declare (ignore verbose-internals))
